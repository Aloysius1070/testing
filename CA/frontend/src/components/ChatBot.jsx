...
const ChatBot = memo(() => {
  ...
  const knowledgeBase = useMemo(() => ({
    ...
    'companies data': 'Companies Data Processor helps:\n- Input company name + purchase and sales daybook\n- Apply mappings for every company\n- Generate purchase and sales output sheets\n- Download one combined Excel file\n\nType "go to companies" to open this tool!',
  ...
  const findBestMatch = useCallback((input) => {
    ...
    if (lowerInput.includes('companies data') || lowerInput.includes('daybook')) {
      return { response: knowledgeBase['companies data'] };
    }
