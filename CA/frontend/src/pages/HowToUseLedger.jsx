    ...
    <div className="container" style={{ maxWidth: '1200px' }}>
      <div className="section">
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '24px', marginBottom: '32px' }}>
          <div style={{ width: '80px', height: '80px', background: 'linear-gradient(135deg, #10b981, #059669)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          ...
          <div style={{ flex: 1 }}>
            <h1 style={{ fontSize: '32px', fontWeight: '700', marginBottom: '8px' }}>Ledger Classification</h1>
            <p style={{ fontSize: '16px', color: '#6b7280', lineHeight: '1.6' }}>
              Automatically categorize ledger entries with AI-powered classification system—fast, consistent, and audit-ready
            </p>
          </div>
        </div>
        ...
        <div style={{ background: 'linear-gradient(135deg, #f0fdf4, #dcfce7)', border: '1px solid #bbf7d0', borderRadius: '12px', padding: '16px 24px', marginBottom: '32px', display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <span style={{ fontWeight: '600', color: '#374151' }}>Manual: 2-3 hours</span>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '32px' }}>
          ...
          <div style={{ background: '#f8fafc', borderRadius: '12px', padding: '24px', border: '1px solid #e2e8f0' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '14px', color: '#475569', lineHeight: '2' }}>
              ...
              <li>• Columns: Description, Amount, Date</li>
          ...
          <div style={{ background: '#f8fafc', borderRadius: '12px', padding: '24px', border: '1px solid #e2e8f0' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '14px', color: '#475569', lineHeight: '2' }}>
              <li>• Analyze transaction descriptions</li>
              <li>• Apply AI classification logic</li>
              <li>• Categorize entries automatically</li>
              <li>• Identify expense types</li>
            </ul>
          </div>
          ...
          <div style={{ background: '#f8fafc', borderRadius: '12px', padding: '24px', border: '1px solid #e2e8f0' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '14px', color: '#475569', lineHeight: '2' }}>
              <li>• Classified ledger entries</li>
              <li>• Category-wise breakdown</li>
              <li>• Excel export ready</li>
              <li>• Editable classifications</li>
            </ul>
          </div>
        </div>
        ...
        <div style={{ background: 'linear-gradient(135deg, #fef3c7, #fde68a)', borderRadius: '12px', padding: '32px', border: '2px solid #fbbf24', marginBottom: '32px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#78350f', marginBottom: '16px', lineHeight: '1.6' }}>
            Watch our step-by-step video guide to learn how to use the Ledger Classification tool effectively.
          </p>
        ...
        <div style={{ background: '#f8fafc', borderRadius: '12px', padding: '32px', border: '1px solid #e2e8f0' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
            <div style={{ padding: '12px 24px', background: 'white', borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '14px', fontWeight: '500' }}>Financial Statements</div>
            <div style={{ padding: '12px 24px', background: 'white', borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '14px', fontWeight: '500' }}>Expense Analysis</div>
            <div style={{ padding: '12px 24px', background: 'white', borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '14px', fontWeight: '500' }}>Budget Planning</div>
            <div style={{ padding: '12px 24px', background: 'white', borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '14px', fontWeight: '500' }}>Audit Preparation</div>
          </div>
        </div>

        {/* CTA Button */}
        <div style={{ textAlign: 'center', marginTop: '40px' }}>
          <Link to="/ledger-tool" className="button gradient" style={{ padding: '14px 32px', fontSize: '16px' }}>
            Try Ledger Classification Now
          </Link>
        </div>
      </div>
    </div>
