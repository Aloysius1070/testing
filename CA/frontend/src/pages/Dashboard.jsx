...
import { FileText, Calculator, Receipt, BookOpen, ArrowRight, Clock, HelpCircle, Lock, TrendingUp, FileSpreadsheet, Building2 } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const tools = [
    ...
    {
      id: 'companies-data',
      title: 'Companies Data Processor',
      description: 'Upload company name, purchase DayBook, and sales DayBook. Process both using mappings and download output workbook.',
      icon: Building2,
      navigateTo: '/companies-data-tool',
      howToUse: '/how-to-use-companies-data',
      badge: 'New',
      className: 'companies-data',
      outcome: 'Standardized mapping for all companies'
    },
    {
      id: 'financial-report',
