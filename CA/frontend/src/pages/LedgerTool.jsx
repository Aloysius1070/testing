...
export default function LedgerTool() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      const result = await simulateLedger(preview.originalFile, onProgressCallback);
        ...
        <div className="hero-header-content">
          <div className="hero-header-left">
            <h1 className="hero-header-title">
              Ledger <span className="gradient-text">Classification</span>
            </h1>
            <p className="hero-header-subtitle">
              Secure, fast, and simple ledger categorization with AI-powered intelligence. Upload your CSV or Excel file to get started.
            </p>
          ...
          <div className="hero-header-illustration">
            <svg viewBox="0 0 400 300" className="hero-illustration-svg">
              <defs>
                <linearGradient id="ledGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#10b981"/>
                  <stop offset="100%" stopColor="#059669"/>
                </linearGradient>
                <linearGradient id="ledGrad2" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <circle cx="150" cy="100" r="80" fill="#d1fae5" opacity="0.3"/>
              <circle cx="250" cy="200" r="60" fill="#dbeafe" opacity="0.3"/>
              <rect x="280" y="80" width="100" height="100" rx="20" fill="#a7f3d0" opacity="0.25" transform="rotate(15 330 130)"/>
              
              {/* Main Ledger Book */}
              <rect x="160" y="90" width="80" height="120" rx="8" fill="url(#ledGrad1)" opacity="0.8"/>
              ...
              <line x1="200" y1="90" x2="200" y2="210" stroke="white" strokeWidth="1.5" opacity="0.3"/>
              
              {/* Category Tags Icon */}
              <circle cx="280" cy="120" r="25" fill="url(#ledGrad2)" opacity="0.9" className="float-check"/>
              <rect x="270" y="112" width="10" height="16" rx="2" fill="white" opacity="0.9"/>
              <rect x="283" y="112" width="10" height="16" rx="2" fill="white" opacity="0.9"/>
              
              {/* Small Floating Documents */}
              <g className="float-doc">
                <rect x="100" y="80" width="30" height="40" rx="3" fill="url(#ledGrad1)" opacity="0.6"/>
              ...
              <g className="float-doc-2">
                <rect x="270" y="200" width="30" height="40" rx="3" fill="url(#ledGrad1)" opacity="0.6"/>
              ...
              <g className="sparkle-1">
                <line x1="120" y1="180" x2="132" y2="180" stroke="url(#ledGrad1)" strokeWidth="2" strokeLinecap="round"/>
                <line x1="126" y1="174" x2="126" y2="186" stroke="url(#ledGrad1)" strokeWidth="2" strokeLinecap="round"/>
              </g>
              <g className="sparkle-2">
                <line x1="310" y1="160" x2="322" y2="160" stroke="url(#ledGrad2)" strokeWidth="2" strokeLinecap="round"/>
                <line x1="316" y1="154" x2="316" y2="166" stroke="url(#ledGrad2)" strokeWidth="2" strokeLinecap="round"/>
              </g>
            </svg>
          </div>
        </div>
        ...
        <div className="process-steps">
          <div className="process-step">
            <div className="step-header">
              ...
              <h3 className="step-title">Ledger Data Upload</h3>
            </div>
            <p className="step-description">
              Upload Excel file containing general ledger entries with transaction descriptions, amounts, dates, and account codes for automated classification.
            </p>
          ...
          <div className="process-step">
            <div className="step-header">
              ...
              <h3 className="step-title">AI-Powered Classification</h3>
            </div>
            <p className="step-description">
              Advanced AI algorithms analyze transaction descriptions and patterns to automatically categorize entries into appropriate ledger accounts and expense categories.
            </p>
            <div className="step-meta">Processing time: ~25 seconds per 1,000 transactions</div>
          </div>

          <div className="process-step">
            <div className="step-header">
              <span className="step-number">3</span>
              <h3 className="step-title">Classification Report</h3>
            </div>
            <p className="step-description">
              Download comprehensive report with classified entries, suggested account codes, confidence scores, and summary statistics for accounting review.
            </p>
            <div className="step-meta">Output format: Excel workbook with classification details</div>
          </div>
        </div>
      </div>
