"""Job storage and management for async companies data extraction processing"""
...
def create_job(job_id: str, filename: str):
    ...
    jobs[job_id] = {
        ...
        'status': 'processing',
        'progress': 0,
        'message': 'Starting companies data extraction...',
...
def update_job_completed(job_id: str, output_bytes: bytes, download_name: str):
    ...
    if job_id in jobs:
        ...
        jobs[job_id]['message'] = 'Companies data extraction complete!'
